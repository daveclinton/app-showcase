...
function Iphone15Pro({
  ...
  return (
    ...
    >
      ...
      />
      <path
        className="fill-[#111111] dark:fill-[#111111]"
      ...
      />
      <path
        className="fill-[#111111] stroke-[#2a2a2a] stroke-[0.5] dark:fill-[#111111] dark:stroke-[#2a2a2a]"
      ...
      />
      <path
        className="fill-[#444444] dark:fill-[#444444]"
...
export function SiteHeader() {
  ...
  const [previewMode, setPreviewMode] = useState<"phones" | "mauri">("phones");
  const isDesktop = useMediaQuery("(min-width: 768px)");
  const pathname = usePathname();
  const showMauriPreview = () => setPreviewMode("mauri");
                  ...
                  <div className="grid gap-6 py-2 md:grid-cols-[minmax(0,0.75fr)_minmax(0,1fr)]">
                          ...
                          return (
                            <li key={item.href}>
                              <Link
                                ...
                                onFocus={item.external ? showMauriPreview : undefined}
                                onBlur={item.external ? showDefaultPreview : undefined}
                                onKeyDown={
                                  item.external
                                    ? (event) => {
                                        if (event.key === "Enter") {
                                ...
                                onMouseEnter={item.external ? showMauriPreview : undefined}
                                onMouseLeave={item.external ? showDefaultPreview : undefined}
                                onClick={() => setHeaderOpen(false)}
                              >
                                {item.label}
                              </Link>
                    ...
                    {isDesktop ? (
                      <div className="flex items-center justify-center py-4">
                        {previewMode === "mauri" ? (
                          <Image
                            alt="Mauri by Tai Ora"
                            className="h-auto w-full max-w-[72rem] drop-shadow-2xl"
                            height={630}
                            src="/og-image.png"
                            width={1200}
                          />
